				...
				<div class="col-md-9 inputGroupContainer">
					<div class="input-group">
						<span class="input-group-addon">
							...
							<input id="taxa" name="taxa" class="form-control" required="required" value="${valoresTaxas.taxaPorKm}" type="text" />
					</div>
				</div>
			</div>
				...
				<div class="col-md-9 inputGroupContainer">
					<div class="input-group">
						<span class="input-group-addon">
							...
							<input id="valor" name="valor" class="form-control" required="required" value="${valoresTaxas.valorDiario}" type="text">
					</div>
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-3 control-label">
					<fmt:message key="aluguel.km" />
				</label>
				<div class="col-md-9 inputGroupContainer">
					<div class="input-group">
						<span class="input-group-addon">
						...
						<input id="kmSaida" name="kmSaida" placeholder="10.000" class="form-control" required="required" type="text">
					</div>
				</div>
			</div>
